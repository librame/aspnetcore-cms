...
namespace Librame.Extensions.Portal.Stores
{
    ...
    /// <summary>
    /// <see cref="long"/> 门户存储标识生成器。
    /// </summary>
    public class LongPortalStoreIdentificationGenerator : AbstractPortalStoreIdentificationGenerator<long>
    {
        /// <summary>
        ...
        public LongPortalStoreIdentificationGenerator(IClockService clock,
