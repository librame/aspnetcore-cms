...
namespace Librame.Extensions.Portal.Stores
{
    ...
    /// <summary>
    /// <see cref="Guid"/> 门户存储标识符生成器。
    /// </summary>
    public class GuidPortalStoreIdentifierGenerator : AbstractPortalStoreIdentifierGenerator<Guid>
    {
        /// <summary>
        ...
        public GuidPortalStoreIdentifierGenerator(IOptions<DataBuilderOptions> options,
