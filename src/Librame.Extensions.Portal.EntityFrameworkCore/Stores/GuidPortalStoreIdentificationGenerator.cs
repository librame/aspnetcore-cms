...
namespace Librame.Extensions.Portal.Stores
{
    ...
    /// <summary>
    /// <see cref="Guid"/> 门户存储标识生成器。
    /// </summary>
    public class GuidPortalStoreIdentificationGenerator : AbstractPortalStoreIdentificationGenerator<Guid>
    {
        /// <summary>
        ...
        public GuidPortalStoreIdentificationGenerator(IClockService clock,
