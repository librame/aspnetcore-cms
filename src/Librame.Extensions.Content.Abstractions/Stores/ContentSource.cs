...
namespace Librame.Extensions.Content.Stores
{
        ...
        where TCreatedBy : IEquatable<TCreatedBy>
    {
        ...
        /// 网站。
        /// </summary>
        [Display(Name = nameof(Website), ResourceType = typeof(AbstractContentResource))]
        public virtual string Website { get; set; }

        /// <summary>
        /// 网标。
        /// </summary>
        [Display(Name = nameof(Weblogo), ResourceType = typeof(AbstractContentResource))]
        ...
        /// </summary>
        /// <param name="other">给定的 <see cref="ContentSource{TIncremId, TCreatedBy}"/>。</param>
        /// <returns>返回布尔值。</returns>
        [SuppressMessage("Design", "CA1062:验证公共方法的参数", Justification = "<挂起>")]
        public virtual bool Equals(ContentSource<TIncremId, TCreatedBy> other)
        ...
        public override bool Equals(object obj)
            => (obj is ContentSource<TIncremId, TCreatedBy> other) && Equals(other);
