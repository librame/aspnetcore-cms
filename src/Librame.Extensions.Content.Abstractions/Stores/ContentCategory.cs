...
namespace Librame.Extensions.Content.Stores
{
    ...
    [Description("类别")]
    public class ContentCategory<TIncremId, TCreatedBy> : AbstractEntityCreation<TIncremId, TCreatedBy>,
        ...
        where TCreatedBy : IEquatable<TCreatedBy>
    {
        ...
        /// </summary>
        /// <param name="other">给定的 <see cref="ContentCategory{TIncremId, TCreatedBy}"/>。</param>
        ...
        public override bool Equals(object obj)
            => (obj is ContentCategory<TIncremId, TCreatedBy> other) && Equals(other);
