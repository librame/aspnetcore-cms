...
namespace Pomelo.EntityFrameworkCore.MySql.Update.Internal
{
    ...
    /// </summary>
    public class MySqlBatchExecutorRewrite : IBatchExecutor
    {
        /// <summary>
        /// 构造一个 <see cref="MySqlBatchExecutorRewrite"/>。
        /// </summary>
        ...
        public MySqlBatchExecutorRewrite(ICurrentDbContext currentContext,
